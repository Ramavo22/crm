...
public class LeadControllerApi {
    ...
    public ResponseEntity<DataTransfertObject> deleteLead(@PathVariable("id") int id) {
        ...
        try {
            ...
            if (lead != null) {
                ...
                // Réponse succès
                dataTransfertObject.setStatusCode(200);
                dataTransfertObject.setMessage("Lead deleted successfully");
                dataTransfertObject.setErreur(null);
                ...
                dataTransfertObject.setMessage("Lead with ID " + id + " not found");
                dataTransfertObject.setErreur(null);
                dataTransfertObject.setData(null);
    ...
    @PutMapping("/update")
    public ResponseEntity<DataTransfertObject> updateLead(@RequestBody LeadDepense depense) {
        DataTransfertObject dataTransfertObject = new DataTransfertObject();
        ...
        try {
            ...
            if (lead != null) {
                ...
                // Réponse de succès
                dataTransfertObject.setStatusCode(200);
                dataTransfertObject.setMessage("Lead updated successfully");
                dataTransfertObject.setErreur(null);
                dataTransfertObject.setData(null);
                ...
                // Lead non trouvé
                dataTransfertObject.setStatusCode(404);
                dataTransfertObject.setMessage("Lead not found");
                dataTransfertObject.setErreur(null);
                dataTransfertObject.setData(null);
